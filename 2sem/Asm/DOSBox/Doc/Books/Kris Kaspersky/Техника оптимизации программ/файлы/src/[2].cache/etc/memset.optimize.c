/*
	Пример, демонстрирующий технику оптимизации заполнения памяти
	путем сквозной записи в системную память, минуя кэш
*/
...
nonstore(char *p, char *val)
{
	...
	/* ----------------------------------------------------------------------
				...
				ПЕССИМИЗИРОВАННЫЙ ВАРИАНТ
							(с использованием MMX'овой инструкции записи)
...
main()
{
	...
	// Иницилизируем выделяемую переменную
