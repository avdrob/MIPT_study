...
REM *************************   Компилируем  *******************************
REM =========================================================================
ECHO [2/3] Компилируем проект "%~n1" by %compil_name% %2 %3 %4 %5 %6 %7
...
IF "%oops%"=="/Zi" ECHO ::с отладочной информацией
IF "%opt%"=="/Ox" ECHO ::откомилированный с максимальной оптимизацией
GOTO END
...
:ERR_NO_CLOCKSDK
ECHO.
ECHO -ERR: Не задана переменная окружения CLOCKSDK v1,
ECHO указывающая путь к пакету CLOCKSDK без  накланной
